...
if (!empty($login_status)) {
	...
	if (in_array('2', $login_status)) {
		...
		$login_status_conditions = $login_status_conditions." (A.mbr_kbn IN (0,1) AND A.order_kbn='1' AND A.item_kbn='1') ";
	}
...
if (!empty($odr_form)) {
    ...
    if (in_array('3', $odr_form)) {
		...
		$odr_form_conditions = $odr_form_conditions." ((A.regular_buy_odr_seq != '' OR A.regular_buy_odr_seq IS NOT NULL) AND A.item_kbn='1' AND A.order_kbn='2')";
	}
    ...
    if (in_array('4', $odr_form)) {
		...
		$odr_form_conditions = $odr_form_conditions." (A.gift_flg = '0' AND A.regular_buy_odr_seq != '' AND A.item_kbn='1' AND A.order_kbn='2')";
	}
	$where[] ='('.$odr_form_conditions.')';
}
