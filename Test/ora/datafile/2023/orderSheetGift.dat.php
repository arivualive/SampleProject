<?
{
    ...
    // お届け先指定の場合
        ...
        // お受取人(住所漢字)
        $add_address  = "■お届け先：　〒".$row['ANOTHER_POST_NO'] .'　';
        ...
        // 電話番号
        $delivery_info .= '■電話番号：　' .getHtmlEscapedString(ssk_decrypt($row['ADD_ANOTHER_TELNO'])) .'<br>';
        // 贈り主名
    ...
    // 贈り物要望
    $gift_body['delivery_request'] = '■贈り物要望：　' .getHtmlEscapedString($row['DELIVERY_REQUEST']) .'<br><br>';
    // メッセージカード要／不要
