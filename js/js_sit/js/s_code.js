...
var s_account="sshpcmain"
if( mydomain.match(/test/i) || mydomain.match(/stage/i) ){
    s_account="sshpcdev"
}
...
//#1273 add 2010/09/27
if( mydomain.match(/www/i) ){
    s.cookieDomainPeriods=3
}else if( mydomain.match(/test/i) || mydomain.match(/stage/i) ){
...
//#1273 add 2010/09/27
s.linkInternalFilters="javascript:,www.saishunkan.co.jp"
if( mydomain.match(/test/i) || mydomain.match(/stage/i) ){
...
function s_doPlugins(s) {
	...
	s.prop13=navigator.userAgent;
	s.prop14=s.getNewRepeat(180);
	if(navigator.userAgent.match(/iPhone/i)) s.prop15=s.eVar15='iPhone';
	else if(navigator.userAgent.match(/iPad/i)) s.prop15=s.eVar15='iPad';
	else if(navigator.userAgent.match(/iPod/i)) s.prop15=s.eVar15='iPod';
    // Plugin Example: trackFirstPartyCookie v2.0
    s.visitorID=s.trackFirstPartyCookie('fst_vi',1825,50);
    
    /* SBT add 20140528 */
	//var s_tlink=s.linkHandler('main.html','e')
	var s_tlink=s.linkHandler('tel:','e');
	if(s_tlink){
		s.eVar29='D=pageName';
...
+"epa(v)}return ''");
/*
 * Plugin: getNewRepeat 1.1 - Return whether user is new or repeat 2011/02/07
 */
